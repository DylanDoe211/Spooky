...
namespace Spooky.Content.Projectiles.Cemetery
{
    public class SlendermanTentacle : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.active && player.GetModPlayer<SlendermanPagePlayer>().SlendermanPage)
            {
                Projectile.timeLeft = 2;
            }
        ...
        {
            if (Main.rand.NextBool(40) && Main.player[Projectile.owner].GetModPlayer<SlendermanPagePlayer>().SlendermanPageDelay <= 0)
            {
