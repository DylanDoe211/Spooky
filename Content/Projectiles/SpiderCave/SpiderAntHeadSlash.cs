...
{ 
    public class SpiderAntHeadSlash : SwordSlashBase
    {
        ...
        public override bool PreAI()
		{
            ...
            {
				Dust dust8 = Dust.NewDustPerfect(Projectile.Center + num10.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), DustID.Torch, vector3 * 2f);
