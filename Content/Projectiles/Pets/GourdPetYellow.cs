...
{
    public class GourdPetYellow : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
		{
			...
			Vector2 scaleStretch = new Vector2(1f - stretch, 1f + (stretch * 0.25f));
        ...
        public override void AI()
        {
			...
			if (player.dead)
            {
				player.GetModPlayer<SpookyPlayer>().GourdPetYellow = false;
            }

			if (player.GetModPlayer<SpookyPlayer>().GourdPetYellow)
            {
				Projectile.timeLeft = 2;
            }
