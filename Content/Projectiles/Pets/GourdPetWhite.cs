...
{
    public class GourdPetWhite : ModProjectile
    {
        int playerStill = 0;
        ...
        public override bool PreDraw(ref Color lightColor)
		{
            ...
            Projectile.GetAlpha(lightColor), Projectile.rotation, new Vector2(ProjTexture.Width() / 2f, ProjTexture.Height() / 2f), scaleStretch, effects, 0);
            ...
            for (int i = 0; i < 360; i += 90)
            {
                ...
                Projectile.GetAlpha(Color.White), Projectile.rotation, new Vector2(ProjTexture.Width() / 2f, ProjTexture.Height() / 2f), scaleStretch, effects, 0);
            }
        ...
        public override void AI()
        {
            ...
            if (player.dead)
            {
				player.GetModPlayer<SpookyPlayer>().GourdPetWhite = false;
            }

			if (player.GetModPlayer<SpookyPlayer>().GourdPetWhite)
            {
				Projectile.timeLeft = 2;
            }
