...
{
    public class SpookFishronWhipBubbleExplosion : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < 360; i += 90)
            {
                ...
                Main.EntitySpriteDraw(ProjTexture.Value, vector + circular, rectangle, color2, Projectile.rotation, drawOrigin, (Projectile.ai[0] / 37) * 0.5f, SpriteEffects.None, 0);
            }
