...
namespace Spooky.Content.NPCs.NoseCult
{
	public class NoseCultistWingedIdle : ModNPC
	{
        ...
        public static readonly SoundStyle TalkSound = new("Spooky/Content/Sounds/TalkSounds/NoseCultistTalk", SoundType.Sound) { Volume = 0.35f, Pitch = -0.5f, PitchVariance = 0.75f };
		...
		public override string GetChat()
		{
            ...
            Language.GetTextValue("Mods.Spooky.Dialogue.NoseWinged.Dialogue" + Main.rand.Next(1, 5)),
