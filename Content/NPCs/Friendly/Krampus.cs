    ...
    public class Krampus : ModNPC  
    {
		...
		public override string GetChat()
		{
			...
			else
			{
				...
				if (!Main.LocalPlayer.HasItem(ModContent.ItemType<QuestPresent1>()) &&
				!Main.LocalPlayer.HasItem(ModContent.ItemType<QuestPresent2>()) &&
				!Main.LocalPlayer.HasItem(ModContent.ItemType<QuestPresent3>()) &&
				!Main.LocalPlayer.HasItem(ModContent.ItemType<QuestPresentLittleEye>()))
				{
					if (!InventoryFull(Main.LocalPlayer))
					{
						DialogueChain chain = new();
						chain.Add(new(UITexture.Value, NPC,
		...
		public override void AI()
		{
			...
			NPC.Distance(Main.LocalPlayer.Center) <= 150f && !Main.mapFullscreen)
			{
