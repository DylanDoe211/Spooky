...
{
	public class ShipyardBiomeTorchItem : ModItem
	{
		...
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<ShipyardBiomeTorch>());
            Item.width = 16;
			Item.height = 16;
			Item.holdStyle = 1;
			Item.flame = true;
		...
		public override void HoldItem(Player player)
		{
			if (!player.wet)
			{
				...
				float divide = 300f;
				Lighting.AddLight(position, new Vector3(133f / divide, 180f / divide, 235f / divide));
			}
		}
		...
		public override void PostUpdate()
		{
			...
			{
				float divide = 300f;
				Lighting.AddLight(Item.Center, new Vector3(133f / divide, 180f / divide, 235f / divide));
			}
		}
		...
		public override void AddRecipes()
        {
			...
			.AddIngredient(ModContent.ItemType<BlackSandstoneItem>(), 1)
            .Register();
        }
	}
}