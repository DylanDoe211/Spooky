...
namespace Spooky.Content.Tiles.Minibiomes.Ocean.Ambient
{
    public class CoralGreen1 : ModTile
    {
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
		{
            ...
            {
                spriteBatch.Draw(PlantTexture.Value, pos + new Vector2(PlantTexRealWidth / 2 - 5, (PlantTexture.Height() / 3) / 2 - 1), new Rectangle(0, 0, 116, 104), col, 0f, 
    ...
    public class CoralGreen2 : CoralGreen1
    {
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
		{
            ...
            if (Framing.GetTileSafely(i, j).TileFrameX == 0 && Framing.GetTileSafely(i, j).TileFrameY == 0)
            {
                spriteBatch.Draw(PlantTexture.Value, pos + new Vector2(PlantTexRealWidth / 2 - 5, (PlantTexture.Height() / 3) / 2 - 1), new Rectangle(0, 106, 116, 104), col, 0f, 
                new Vector2(PlantTexRealWidth, PlantTexture.Height() / 3), 1f, SpriteEffects.None, 0f);
            }
        }
    ...
    public class CoralGreen3 : CoralGreen1
    {
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
		{
            ...
            if (Framing.GetTileSafely(i, j).TileFrameX == 0 && Framing.GetTileSafely(i, j).TileFrameY == 0)
            {
                spriteBatch.Draw(PlantTexture.Value, pos + new Vector2(PlantTexRealWidth / 2 - 5, (PlantTexture.Height() / 3) / 2 - 1), new Rectangle(0, 106 * 2, 116, 104), col, 0f, 
                new Vector2(PlantTexRealWidth, PlantTexture.Height() / 3), 1f, SpriteEffects.None, 0f);
            }
        }
